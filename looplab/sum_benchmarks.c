...
function_info functions[] = {
    ...
    // ADD ENTRIES HERE!
    {sum_unrolled2, "sum_unrolled2: simple ASM implementation"},
    {sum_unrolled4, "sum_unrolled4: simple ASM implementation"},
    {sum_multiple_accum, "sum_multiple_accum: simple ASM implementation"},
    {NULL, NULL},
};
